...
keymap_normal("<leader>xx", "<cmd>Trouble diagnostics toggle<CR>")
keymap_normal("<leader>xw", "<cmd>Trouble workspace_diagnostics toggle<cr>")
keymap_normal("<leader>xd", "<cmd>Trouble document_diagnostics toggle<cr>")
